"""
Django settings for hr_helper project.
...
SECRET_KEY = 'django-insecure-=&0h8kfswfva+a9#jd^2y4sc**tu^&j*+f6etu8l6lxms6!rh='
...
WSGI_APPLICATION = 'hr_helper.wsgi.application'
